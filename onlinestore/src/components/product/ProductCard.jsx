...
export default function ProductCard({ cartItems, setCartItems }) {
  ...
  // Define navigate function to handle navigation
  ...
  const handleSearch = () => {
    // Check if any search filters are modified from their default values
    const isSearchFilterModified =
      selectedCategory !== "all" ||
      selectedPriceRange !== "all" ||
      searchQuery.trim() !== "";

    if (!isSearchFilterModified) {
      return; // If no filters are modified, do not execute the search
    }
    // Filter the products based on the selected category, price range, and search query
    ...
    navigate("/searchresult", {
      state: { searchResults: filteredSearchResults },
    });
  };
  return (
